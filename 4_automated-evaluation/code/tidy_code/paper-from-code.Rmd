...
ggsave("indicator-figs_fig-3_indicator_by_pmc.jpg")
```
...
# Fig 4: Indicators by year and country
...
ggsave(
  "indicator-figs_fig-4_indicator-by-year-country.jpg", 
  height = 10, 
  width = 9
)
```
...
ggsave("indicator-figs_fig-5_field-by-indicator.jpg", width = 8, height = 6)
```
...
ggsave(
  "indicator-figs_fig-6_indicator-by-journal-publisher.jpg", 
  width = 10,
  height = 12
)
```
