...
load("../../../3_algorithm-validation/COI/Code/coi-eval-out_coi.RData")
load("../../../3_algorithm-validation/Funding/Code/fund-eval-out_fund.RData")
load("../../../3_algorithm-validation/Registration/Code/register-eval-out_reg.RData")
load("../../../3_algorithm-validation/Data sharing/Code/data-code-eval_out-data.RData")
load("../../../3_algorithm-validation/Data sharing/Code/data-code-eval_out-code.RData")
```
